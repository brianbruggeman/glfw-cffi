...
def get_package_metadata(project_name=None):
    ...
    '''
    docs_folder = os.path.abspath(os.path.dirname(__file__))
    top_folder = os.path.abspath(os.path.dirname(docs_folder))
...
project = ' '.join(
    _.capitalize()
    for _ in package_metadata['project'].replace('_', '-').split('-')
)
...
version = '.'.join(map(str, package_metadata['version'][:2]))
# The full version, including alpha/beta/rc tags.
release = package_metadata['versionstr']
...
#
# html_title = u'Insert a better title here and uncomment!'
